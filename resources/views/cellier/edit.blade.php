            ...
            <div class="relative px-4 py-10 bg-white">
                <div class="max-w-full mx-auto">
                    <div class="flex items-center space-x-5">
                            ...
                            <h2 class="leading-relaxed">Modifier votre cellier</h2>
                        ...
                        -->
                            ...
                            <div class="pt-4 flex items-center space-x-4">
                                ...
                                <button class="bg-red-800 flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none">Modifier</button>
