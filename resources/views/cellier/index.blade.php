...
@section('content')
        ...
        <div class='max-w-full p-5 flex flex-wrap justify-evenly'>
            ...
            @if ($celliers)
                @foreach ($celliers as $info)
                    ...
                    <div class="w-full max-w-sm min-w-max m-2 border border-gray-200 rounded-lg shadow">   
                          ...
                          <div class="flex p-2 space-x-2 justify-end bg-gray-100">
                            <!-- zone edit cellier-->
                        ...
                        <div class="flexboutonCellier flex gap-y-px">
                            ...
                            <a class=" w-full text-center bg-slate-800 text-white  py-2 px-4 border-r-2 border-white" href='{{ route('bouteille.liste', ['id' => $info->id]) }}'>Voir bouteille</a>
                            @endif
                            <a class=" w-full text-center bg-slate-800 text-white  py-2 px-4" href='{{ route('bouteille.nouveau', ['id' => $info->id]) }}'>Ajouter bouteille</a>
                        </div>
                    </div>
