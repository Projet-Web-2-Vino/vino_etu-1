        ...
        @endif
            ...
            @if ($celliers)
                ...
                {{-- FIN NOUVELLE SECTION CARTE CELLIER --}}
                    ...
                    <div class="py-5   border border-gray-200 rounded-lg hover:shadow-xl ">
